...
func TestFailingSocketHandler2(test *testing.T) {
	...
	hub := newHub()
	go hub.run()
	server, connection := NewGameWebSocketServer2(test, gameUsecases, 3, "P1", hub)
...
func TestSocketHandler2(test *testing.T) {
	...
	test.Run("Receive the teaming phase when full", func(test *testing.T) {
		s2, c2 = NewGameWebSocketServer2(test, gameUsecases, 1, "P2", hub)
		s3, c3 = NewGameWebSocketServer2(test, gameUsecases, 1, "P3", hub)
		s4, c4 = NewGameWebSocketServer2(test, gameUsecases, 1, "P4", hub)
	...
	test.Run("Try to join when already in game", func(test *testing.T) {
		s5, c5 = NewGameWebSocketServer2(test, gameUsecases, 1, "P4", hub)
	...
	test.Run("Try to join a full game", func(test *testing.T) {
		s5, c5 = NewGameWebSocketServer2(test, gameUsecases, 1, "P5", hub)
